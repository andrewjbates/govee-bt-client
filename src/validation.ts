...
export const isHt5074 = (hex: string) =>
    hex.startsWith(h5074_uuid_rev) && hex.length == 18; // Govee H5074
export const isHt5075 = (hex: string) =>
    hex.startsWith(h5075_uuid_rev) && hex.length == 16; // Govee H5072/H5075
export const isHt5101 = (hex: string) => hex.startsWith(h5101_uuid_rev); // Govee H5100/H5101/H5102
export const isHt5179 = (hex: string) =>
    hex.startsWith(h5179_uuid_rev) && hex.length == 22; // Govee H5179
